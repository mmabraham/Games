...
if __FILE__ == $PROGRAM_NAME
  board = Chess::Board.new
  display = Chess::Display.new(board)
  player1 = Chess::HumanPlayer.new(display, :white, "White")
  player2 = Chess::HumanPlayer.new(display, :black, "Black")
  player3 = Chess::BFSPlayer.new(display, :white, "BFS Bot")
  player4 = Chess::DFSPlayer.new(display, :black, "DFS Bot")

  if ARGV[0] == '-h'
    game = Chess::Game.new(player1, player2, board)
  elsif ARGV[0] == '-c'
    game = Chess::Game.new(player3, player4, board)
  else
    game = Chess::Game.new(player1, player4, board)
  end
  game.play
end
